...
> [!IMPORTANT]
> 当前仓库维护 AINexus 版本，重点增强 Codex CLI、Claude Code、Hermes Agent、OpenClaw、OpenAI Responses API、DeepSeek、Kimi 等兼容场景。
>
> 最新发布：[`AINexus`](https://github.com/jackychanisnotme/AINexus/releases/latest)
...
AINexus 桌面端把统计概览、端点启停、客户端启动器、数据同步和日志调试放在同一个控制面板中，便于在 Codex CLI、Claude Code、Hermes Agent 与 OpenClaw 之间快速切换 API Provider。
...
[下载 AINexus 最新版本](https://github.com/jackychanisnotme/AINexus/releases/latest)
...
本项目使用 [AINexus Source-Available License](LICENSE)。非商业个人、教育、研究和评估用途可查看、下载、复制、运行和修改源码及编译产物；商业使用需获得仓库所有者的事先书面授权。
